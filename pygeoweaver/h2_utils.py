...
# HISTORY is strict: a mid-import truncate often leaves WORKFLOW intact while
# history rows are only half-loaded — that must refuse promote.
H2_INVENTORY_STRICT_TABLES = ("WORKFLOW", "GWPROCESS", "HOST", "HISTORY")
H2_INVENTORY_SOFT_TABLES = ("ENVIRONMENT", "WORKFLOW_CHECKPOINT")
